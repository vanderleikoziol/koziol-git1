...
matriz = np.array([lin1,
                   ...
                   lin19,
                   lin20])
prod = 0  # Variável atualizada sempre que um produto maior for encontrado
cont = 0  # Variável atualizada quando um novo produto é calculado
el_prod = []  # Lista na qual é guardada os elementos geradores do maior produto
...
print(f'O maior produto é {prod}, resultado da multiplicação de {el_prod}, sendo realizada {cont} operações')
